...
<div class=" section">
    <!--  -->
    <div id="democracia" class="scrollspy">
            ...
            <div class="col s12 l9 offset-l2 center">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6">
                        ...
                        <div class="col s12 green darken-4"><br /></div>
                        <p class="white-text">
            ...
            <div class="col s12 l9 offset-l2 center">
                <div class="row">
                    ...
                    <div class="col s12">
                        ...
                        <!--linea azul decorativa-->
                        <div class="col s12 green darken-4"></div>
    ...
    <div id="orientacion" class="scrollspy  valign-wrapper">
        <div class="row">
            <!--titulo de articulo-->
            <div class="col s12 l9 offset-l2 center">
                <h4 class="yellow-text"><b>Proyecto de Orientación Vocacional y Proyecto de Vida</b></h4>
