...
<div class=" section">
    ...
    <div id="democracia" class="scrollspy  valign-wrapper">
        <div class="row">
            ...
            <div class="col s12 l10 offset-l2 center">
                <h4 class="yellow-text"><b>Proyecto Pedagógico de Democracia y Derechos Humanos</b>
                </h4>
                <div class="col s12 m6">

                    <p class="white-text">Comité de democracia</p>
                ...
                <div class="col s12 m6">
                    ...
                    <ul style="padding-left: 25px; font-size: 24px;" class="white-text">
    ...
    <div id="orientacion" class="scrollspy  valign-wrapper">
        <div class="row">
            <!--titulo de articulo-->
            <div class="col s12 l10 offset-l2 center">
                <h4 class="yellow-text"><b>Proyecto de Orientación Vocacional y Proyecto de Vida</b>
                </h4>

                <!--titulo de articulo-->
                <p class="white-text">Psicoorientación.</p>
                <!--linea azul decorativa-->
                <div class="col s12 green darken-4" style="font-size: 6px;"><br /></div>
    ...
    <div id="direccion-grado" class="scrollspy container">
        <div class="row">
            <!--titulo de articulo-->
            <div class="col s12 l10 offset-l2 center">
                <h4 class="yellow-text"><b>Proyecto de Dirección de Grado</b></h4>

                <!--linea azul decorativa-->
                <div class="col s12 green darken-4" style="font-size: 6px;"><br /></div>
                <!--Cuerpo de articulo-->
                <div class="col s12 m6">
                    <p class="white-text"> Teniendo en cuenta la situaciones vividas por los estudiantes
                        en
                        los
    ...
    <div id=" escuela-padres" class="scrollspy container">
        <div class="row">
            <!--titulo de articulo-->
            <div class="col s12 l10 offset-l2 center">
                <h4 class="yellow-text"><b>Proyecto de Escuela para Padres</b></h4>
                <div class="col s12 green darken-4" style="font-size: 6px;"><br /></div>
            </div>
    ...
    <div id="atencion-padres" class=" scrollspy container">
        <div class="row">
            ...
            <!--titulo de articulo-->
            <div class="col s12 l10 offset-l2 center">
                <h4 class="yellow-text"><b>Proyecto Institucional de Atención a Padres de Familia</b>
                </h4>
                <div class="col s12 green darken-4" style="font-size: 6px;"><br /></div>
            </div>
    ...
    <div id="tiempo-libre" class="scrollspy container">
        <div class="row">
            <!--titulo de articulo-->
            <div class="col s12 l10 offset-l2 center">
                <h4 class="yellow-text"><b>Proyecto de Aprovechamiento del Tiempo Libre</b></h4>
                <div class="col s12 green darken-4" style="font-size: 6px;"><br /></div>
            </div>

            <div class="col s12  offset-l2 center">
                <!--linea azul decorativa-->
                <div class=" col s12 m5">
                    <p class="white-text" style="font-size: 24px;">
